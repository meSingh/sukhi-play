 ...
 *
 * Nothing a child makes goes near this. Their pictures are in IndexedDB, which
 * this does not touch; clearing the cache costs a download, not a drawing.
 */

/* Bumping this drops every previous cache on the next activation. */
const CACHE = 'sukhi-colouring-v1';
